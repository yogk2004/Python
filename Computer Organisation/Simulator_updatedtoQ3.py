...
def BinaryGen(num,length):    
    ...
    if num>=0.03125:
        ...
        mantissa+="0"
    binary_str_8bit=DecimaltoBinary(exponent+3,3)+mantissa
    num=(length-len(binary_str_8bit))*"0"+binary_str_8bit
...
def instruct_exe(list_input,PC,dict_register,dict_var,line_num,Flag_jump):
    ...
    for list_line in list_input2:
        ...
        #Type A Instructions:
        if opcode=="00000" or opcode=="00001" or opcode=="00110" or opcode=="01010" or opcode=="01011" or opcode=="01100" or opcode=="10000":
            ...
            if opcode=="00000":
                ...
                #Addition
                new_val=DecimalGen(dict_register[reg2][8:])+DecimalGen(dict_register[reg3][8:])
                if new_val>31.5:
                    dict_register[reg1]="0000000000000000"
                    dict_register["FLAGS"]=dict_register["FLAGS"][0:12]+"1"+dict_register["FLAGS"][13:]
                else:
                    dict_register[reg1]=BinaryGen(new_val,16) 
            elif opcode=="00001":
                #Subtraction
                new_val=BinarytoDecimal(dict_register[reg2])-BinarytoDecimal(dict_register[reg3])
                if new_val<0:
        ...
        #Type B Instructions:
        elif opcode=="00010" or opcode=="01000" or opcode=="01001" or opcode=="10010":
            ...
            if opcode=="00010":
                ...
                reg1=Registers_code(list_line[5:8])
                Imm=list_line[8:]
                #Movf Immediate
                dict_register[reg1]="00000000"+Imm
            elif opcode=="01000":
                #Right Shift
